...
1. Baixe o JavaFX 16 SDK e extraia os conteúdos do .zip; 
	...
	Nossos testes foram feitos usando Windows x64, a versão exata usada nos nossos testes pode ser baixada diretamente nesse link: https://gluonhq.com/download/javafx-16-sdk-windows/
	
2. Usamos um vídeo como tutorial para configurarmos o eclipse para funcionar com JavaFX
	Link para o vídeo: https://www.youtube.com/watch?v=bk28ytggz7E
